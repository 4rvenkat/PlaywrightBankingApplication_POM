...
- main:
  ...
  - text: —
  - heading "Credit Card Application" [level=2]
  - text: Full Name *
  - textbox "Full Name *": John
  - text: Email
  - textbox "Email": john@gmail.com
  - text: Phone Number *
  - textbox "Phone Number *": "4827492548"
  - text: Address *
  - textbox "Address *": crest street
  - text: Account Number *
  - textbox "Account Number *": "126373633"
  ...
  - text: Upload Proof of Identity (PDF) *
  - button "Upload Proof of Identity (PDF) *"
